        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
          ...
          >
            <div className="relative">
              ...
              />
              {/* Decorative accent */}
              <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-gradient-to-br from-purple-600 to-purple-400 rounded-full blur-3xl opacity-30" />
            </div>
          </motion.div>
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-3 px-6 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-purple-500 text-white font-medium hover:from-purple-500 hover:to-purple-400 transition-all"
            >
